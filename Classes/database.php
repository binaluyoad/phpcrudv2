...
class database {
    ...
    function viewdata($id){
        try {
            ...
            user_address.street, user_address.barangay, user_address.province, user_address.city, user_address.street, user_address.province from users inner join user_address on users.user_id = user_address.user_id  WHERE users.user_id=?");
            $query->execute([$id]);
            return $query->fetch();
